...
proc create_root_design { parentCell } {
  ...
  set audio_ip_0 [ create_bd_cell -type ip -vlnv user:user:audio_ip:1.0 audio_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins audio_ip_0/S00_AXI] [get_bd_intf_pins axi_mem_intercon/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net audio_ip_0_AUD_PWM [get_bd_ports AUD_PWM] [get_bd_pins audio_ip_0/AUD_PWM]
  connect_bd_net -net audio_ip_0_AUD_SD [get_bd_ports AUD_SD] [get_bd_pins audio_ip_0/AUD_SD]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins audio_ip_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins audio_ip_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x40000 -offset 0xC0000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0

...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set aud_vcc [ create_bd_port -dir O aud_vcc ]
  ...
  # Create instance: audio_ip_0, and set properties
  set audio_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:audio_ip:1.0 audio_ip_0 ]
  ...
  set_property -dict [ list CONFIG.Enable_B {Always_Enabled} CONFIG.Memory_Type {Single_Port_RAM} CONFIG.Port_B_Clock {0} CONFIG.Port_B_Enable_Rate {0} CONFIG.Port_B_Write_Rate {0} CONFIG.Use_RSTB_Pin {false}  ] $blk_mem_gen_0

  # Create instance: clk_wiz_1, and set properties
  set clk_wiz_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_1 ]
  set_property -dict [ list CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin}  ] $clk_wiz_1
  ...
  set_property -dict [ list CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_I_LMB {1} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_FPU {1} CONFIG.C_USE_HW_MUL {1}  ] $microblaze_0
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins audio_ip_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  ...
  # Create port connections
  connect_bd_net -net audio_ip_0_aud_vcc [get_bd_ports aud_vcc] [get_bd_pins audio_ip_0/aud_vcc]
  connect_bd_net -net audio_ip_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins audio_ip_0/pwm_out]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins audio_ip_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins audio_ip_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs audio_ip_0/S00_AXI/S00_AXI_reg] SEG_audio_ip_0_S00_AXI_reg
